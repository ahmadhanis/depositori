...
if ($_SESSION["session_id"]) {
    ...
    if (isset($_GET['button'])) {
        ...
        $sqllistquestions = "SELECT * FROM tbl_questions_str INNER JOIN tbl_user ON tbl_questions_str.user_email = tbl_user.email WHERE tbl_questions_str.form = '$yearform' AND tbl_questions_str.subject_name = '$subject' ORDER BY tbl_questions_str.date_created DESC";
    }
    ...
    <div class="main">
        <div class="row-single">
            <div class="card-header" type="submit">
                ...
                ?>
                <?php
                echo "<p>Subject Selected " . $subject . " - Structured Questions</p>";
                ?>
            </div>
        </div>
